    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisationIdentityTemplateName', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('presentationDefinitionId', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
