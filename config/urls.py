...
from data_disclosure_agreement.views import DataDisclosureAgreementsView, DataDisclosureAgreementTemplatesView
...
urlpatterns = [
    ...
    path("data-disclosure-agreements/", DataDisclosureAgreementTemplatesView.as_view(),
